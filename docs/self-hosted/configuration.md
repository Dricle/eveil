...
Once that's saved, any organization member connects their own profile from **Settings → LinkedIn**, grants it to whichever projects should post through it, and sets a posting cadence per project. Every draft — from the daily knowledge-base rotation, a client win, relevant industry news, or drafted by asking Evie — lands in **Campaigns → LinkedIn posts** for review; nothing publishes without an explicit approve.
