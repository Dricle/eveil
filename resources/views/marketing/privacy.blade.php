...
>
    ...
    >
        ...
        <p class="legal-p" style="margin-bottom:14px">The hosted edition's agents currently run on Anthropic's Claude models. Site content, target profile drafts, company and contact information, message drafts, LinkedIn, X and Bluesky post drafts, and public Reddit thread text are sent to Anthropic's API to be processed and are subject to Anthropic's own commercial API terms, under which API inputs are not used to train their models by default. If that changes, or if we add or switch providers, this section will say so before it takes effect.</p>
        ...
        <div style="border:1px solid rgba(232,236,242,.1);border-radius:12px;overflow:hidden;margin-bottom:16px">
            <table style="width:100%;border-collapse:collapse;font-size:14.5px;text-align:left">
                ...
                <tbody>
                    ...
                    <tr><td style="padding:13px 16px;border-top:1px solid rgba(232,236,242,.08)">Anthropic</td><td style="padding:13px 16px;border-top:1px solid rgba(232,236,242,.08);color:rgba(232,236,242,.62)">AI agent inference (site analysis, targeting, writing, LinkedIn, X and Bluesky post drafting, Reddit reply drafting, reply handling)</td><td style="padding:13px 16px;border-top:1px solid rgba(232,236,242,.08);color:rgba(232,236,242,.62)">US</td></tr>
                </tbody>
            </table>
        </div>
