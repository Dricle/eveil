...
>
    ...
    >
        ...
        <p class="legal-p">The service is provided without an uptime guarantee unless we agree to one with you separately in writing. We are not responsible for an outage or degraded behavior caused by a third-party AI provider, payment processor, or other service Eveil depends on. To the fullest extent permitted by law, DRICLE LLP is not liable for any indirect, incidental, special, or consequential loss (including lost profits, lost data, or lost business opportunity) arising from your use of the service, and our total liability for any claim is capped at the amount you paid us in the 12 months before the claim arose. Nothing in these terms excludes or limits liability that cannot lawfully be excluded or limited, including liability for death or personal injury caused by negligence, or for fraud.</p>
        ...
        <p class="legal-p" style="margin-bottom:40px">You may delete your account at any time from your account settings; doing so deletes any organization that account solely owns, along with its projects. This is immediate and irreversible: there is no export window between a deletion request and the data being purged, so export anything you need first. Deleting your account forfeits any unused credit balance, consistent with credits being non-refundable once purchased. We may suspend or terminate an account that breaches section 3; data in a suspended or terminated account is still governed by the periods on our <a href="{{ route('data-retention') }}">Data retention</a> page.</p>
